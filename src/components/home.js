...
<label for="toggle" class="toggleContainer relative grid grid-cols-2 w-fit border-3  bg-espresso text-butter pointer before:content[''] before:absolute before:w-1/2 before:h-full before:left-0 before:bg-butter before:transition-all before:duration-300 ">
<div class="px-2 py-1 text-center z-1">Metric</div>
<div class="px-2 py-1 text-center z-1">Stupid</div>
</label>
...
<button type="submit" class="bg-butter px-4 py-2 duration-200 text-espresso border cursor-pointer border-butter hover:bg-transparent hover:text-butter">Search</button>
</form>
</div>
</div>
